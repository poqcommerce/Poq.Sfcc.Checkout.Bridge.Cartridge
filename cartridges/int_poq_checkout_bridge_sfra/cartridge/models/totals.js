...
function totals(lineItemContainer) {
    if (lineItemContainer) {
        ...
        this.unformattedTotalShippingCost = lineItemContainer.shippingTotalPrice.value;
        ...
        if (this.totalShippingCost === '-') {
            ...
            this.unformattedGrandTotal = lineItemContainer.totalGrossPrice.value;
            this.unformattedTax = lineItemContainer.totalTax.value;
